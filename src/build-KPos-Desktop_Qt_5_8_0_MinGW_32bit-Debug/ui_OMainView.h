/********************************************************************************
** Form generated from reading UI file 'OMainView.ui'
**
...
#ifndef UI_OMAINVIEW_H
#define UI_OMAINVIEW_H
...
#include "../OutStock/OListView.h"
#include "../OutStock/OTitleWidget.h"
...
public:
    ...
    void setupUi(QWidget *OMainView)
    {
        if (OMainView->objectName().isEmpty())
            OMainView->setObjectName(QStringLiteral("OMainView"));
        OMainView->resize(766, 523);
        verticalLayout = new QVBoxLayout(OMainView);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(OMainView);
...
"color:#999999;"));
        ...
        listView = new OListView(mainWidget);
...
"}"));
        ...
        retranslateUi(OMainView);

        QMetaObject::connectSlotsByName(OMainView);
    } // setupUi

    void retranslateUi(QWidget *OMainView)
    {
        OMainView->setWindowTitle(QApplication::translate("OMainView", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("OMainView", "\346\227\245\346\234\237\347\255\233\351\200\211\357\274\232", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("OMainView", "1/1\351\241\265", Q_NULLPTR));
        deleteButton->setText(QApplication::translate("OMainView", "\345\210\240\351\231\244", Q_NULLPTR));
        checkButton->setText(QApplication::translate("OMainView", "\345\256\241\346\240\270", Q_NULLPTR));
        printButton->setText(QApplication::translate("OMainView", "\346\211\223\345\215\260", Q_NULLPTR));
        searchButton->setText(QApplication::translate("OMainView", "\346\237\245\347\234\213", Q_NULLPTR));
        editButton->setText(QApplication::translate("OMainView", "\347\274\226\350\276\221", Q_NULLPTR));
        addButton->setText(QApplication::translate("OMainView", "\346\226\260\345\242\236", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class OMainView: public Ui_OMainView {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_OMAINVIEW_H
