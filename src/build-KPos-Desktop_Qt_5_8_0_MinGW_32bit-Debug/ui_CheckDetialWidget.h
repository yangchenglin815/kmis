/********************************************************************************
** Form generated from reading UI file 'CheckDetialWidget.ui'
**
...
#ifndef UI_CHECKDETIALWIDGET_H
#define UI_CHECKDETIALWIDGET_H
...
public:
    ...
    CheckDetialTitleWidget *titleWidget;
    CheckDetialListView *listView;
    ...
    void setupUi(QWidget *CheckDetialWidget)
    {
        if (CheckDetialWidget->objectName().isEmpty())
            CheckDetialWidget->setObjectName(QStringLiteral("CheckDetialWidget"));
        CheckDetialWidget->resize(766, 523);
        verticalLayout = new QVBoxLayout(CheckDetialWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(CheckDetialWidget);
        ...
        searchWidget->setSizeIncrement(QSize(26, 3));
        searchWidget->setBaseSize(QSize(262, 32));
        ...
        mainWidget = new QWidget(CheckDetialWidget);
        mainWidget->setObjectName(QStringLiteral("mainWidget"));
        verticalLayout_2 = new QVBoxLayout(mainWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        titleWidget = new CheckDetialTitleWidget(mainWidget);
        ...
        listView = new CheckDetialListView(mainWidget);
...
"}"));
        ...
        bottomWidget->setSizeIncrement(QSize(76, 7));
        bottomWidget->setBaseSize(QSize(766, 70));
...
"color:#999999;"));
        ...
        totalLabel->setStyleSheet(QString::fromUtf8("font-family:\"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
"font-size:20px;\n"
"font-weight:bold;\n"
"color:#ea8852;\n"
"\n"
""));
        ...
        retranslateUi(CheckDetialWidget);

        QMetaObject::connectSlotsByName(CheckDetialWidget);
    } // setupUi

    void retranslateUi(QWidget *CheckDetialWidget)
    {
        CheckDetialWidget->setWindowTitle(QApplication::translate("CheckDetialWidget", "Form", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("CheckDetialWidget", "1/1\351\241\265", Q_NULLPTR));
        label->setText(QApplication::translate("CheckDetialWidget", "\346\200\273\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        totalLabel->setText(QApplication::translate("CheckDetialWidget", "\357\277\24510000.00", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CheckDetialWidget: public Ui_CheckDetialWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHECKDETIALWIDGET_H
