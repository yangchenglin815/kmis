/********************************************************************************
** Form generated from reading UI file 'AdjustPriceGoodsSelectWidget.ui'
**
...
#ifndef UI_ADJUSTPRICEGOODSSELECTWIDGET_H
#define UI_ADJUSTPRICEGOODSSELECTWIDGET_H
...
#include "AdjustPriceGoodsSelectTitleWidget.h"

QT_BEGIN_NAMESPACE

class Ui_AdjustPriceGoodsSelectWidget
{
public:
    QVBoxLayout *verticalLayout;
    AdjustPriceGoodsSelectTitleWidget *titleWidget;
    AdjustPriceGoodsSelectListView *listView;
    QWidget *leftWidget;
    ...
    void setupUi(QWidget *AdjustPriceGoodsSelectWidget)
    {
        if (AdjustPriceGoodsSelectWidget->objectName().isEmpty())
            AdjustPriceGoodsSelectWidget->setObjectName(QStringLiteral("AdjustPriceGoodsSelectWidget"));
        AdjustPriceGoodsSelectWidget->resize(288, 470);
        verticalLayout = new QVBoxLayout(AdjustPriceGoodsSelectWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        titleWidget = new AdjustPriceGoodsSelectTitleWidget(AdjustPriceGoodsSelectWidget);
        ...
        listView = new AdjustPriceGoodsSelectListView(AdjustPriceGoodsSelectWidget);
...
"background-color: rgb(250, 250, 250);"));
        ...
        leftWidget = new QWidget(AdjustPriceGoodsSelectWidget);
...
"padding-top:6px;"));
        ...
        retranslateUi(AdjustPriceGoodsSelectWidget);

        QMetaObject::connectSlotsByName(AdjustPriceGoodsSelectWidget);
    } // setupUi

    void retranslateUi(QWidget *AdjustPriceGoodsSelectWidget)
    {
        AdjustPriceGoodsSelectWidget->setWindowTitle(QApplication::translate("AdjustPriceGoodsSelectWidget", "Form", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("AdjustPriceGoodsSelectWidget", "1/1\351\241\265", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class AdjustPriceGoodsSelectWidget: public Ui_AdjustPriceGoodsSelectWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADJUSTPRICEGOODSSELECTWIDGET_H
