...
#include "../InStock/InquireListView.h"
#include "../InStock/InquireTitleWidget.h"
...
public:
    ...
    InquireTitleWidget *titleWidget;
    InquireListView *listView;
    ...
    void setupUi(QWidget *Inquire)
    {
        ...
        Inquire->resize(766, 523);
        verticalLayout = new QVBoxLayout(Inquire);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(Inquire);
        ...
        listView = new InquireListView(mainWidget);
...
""));
    ...
    {
        Inquire->setWindowTitle(QApplication::translate("Inquire", "Form", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("Inquire", "1/1\351\241\265", Q_NULLPTR));
        label->setText(QApplication::translate("Inquire", "\346\200\273\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        totalLabel->setText(QApplication::translate("Inquire", "\357\277\24510000.00", Q_NULLPTR));
    } // retranslateUi
