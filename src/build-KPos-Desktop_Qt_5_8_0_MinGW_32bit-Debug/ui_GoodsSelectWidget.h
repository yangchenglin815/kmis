/********************************************************************************
** Form generated from reading UI file 'GoodsSelectWidget.ui'
**
...
#ifndef UI_GOODSSELECTWIDGET_H
#define UI_GOODSSELECTWIDGET_H
...
#include "../InStock/InStockGoodsSelectListView.h"
#include "../InStock/InStockGoodsSelectTitleWidget.h"

QT_BEGIN_NAMESPACE

class Ui_GoodsSelectWidget
{
public:
    QVBoxLayout *verticalLayout;
    InStockGoodsSelectTitleWidget *titleWidget;
    InStockGoodsSelectListView *listView;
    QWidget *leftWidget;
    ...
    void setupUi(QWidget *GoodsSelectWidget)
    {
        if (GoodsSelectWidget->objectName().isEmpty())
            GoodsSelectWidget->setObjectName(QStringLiteral("GoodsSelectWidget"));
        GoodsSelectWidget->resize(288, 470);
        ...
        GoodsSelectWidget->setPalette(palette);
        verticalLayout = new QVBoxLayout(GoodsSelectWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        titleWidget = new InStockGoodsSelectTitleWidget(GoodsSelectWidget);
        ...
        listView = new InStockGoodsSelectListView(GoodsSelectWidget);
...
"background-color: rgb(250, 250, 250);"));
        ...
        leftWidget = new QWidget(GoodsSelectWidget);
...
"padding-top:6px;"));
        ...
        bottomWidget = new QWidget(GoodsSelectWidget);
...
"padding-top:-12px;"));
        ...
        retranslateUi(GoodsSelectWidget);

        QMetaObject::connectSlotsByName(GoodsSelectWidget);
    } // setupUi

    void retranslateUi(QWidget *GoodsSelectWidget)
    {
        GoodsSelectWidget->setWindowTitle(QApplication::translate("GoodsSelectWidget", "Form", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("GoodsSelectWidget", "1/1\351\241\265", Q_NULLPTR));
        label->setText(QApplication::translate("GoodsSelectWidget", "     \346\200\273\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        totalLabel->setText(QApplication::translate("GoodsSelectWidget", "TextLabel", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class GoodsSelectWidget: public Ui_GoodsSelectWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_GOODSSELECTWIDGET_H
