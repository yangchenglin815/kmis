/********************************************************************************
** Form generated from reading UI file 'ReceiptListWidget.ui'
**
...
#ifndef UI_RECEIPTLISTWIDGET_H
#define UI_RECEIPTLISTWIDGET_H
...
public:
    ...
    ReceiptTitleWidget *titleWidget;
    ReceiptListView *listView;
    ...
    void setupUi(QWidget *ReceiptListWidget)
    {
        if (ReceiptListWidget->objectName().isEmpty())
            ReceiptListWidget->setObjectName(QStringLiteral("ReceiptListWidget"));
        ReceiptListWidget->resize(766, 523);
        ReceiptListWidget->setSizeIncrement(QSize(76, 52));
        ReceiptListWidget->setBaseSize(QSize(766, 523));
        verticalLayout = new QVBoxLayout(ReceiptListWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(ReceiptListWidget);
...
"color:#999999;"));
        ...
        mainWidget = new QWidget(ReceiptListWidget);
        mainWidget->setObjectName(QStringLiteral("mainWidget"));
        verticalLayout_2 = new QVBoxLayout(mainWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        titleWidget = new ReceiptTitleWidget(mainWidget);
        ...
        listView = new ReceiptListView(mainWidget);
...
"padding-top:6px;"));
        ...
        checkButton->setMinimumSize(QSize(80, 0));
...
"}"));
        ...
        retranslateUi(ReceiptListWidget);

        QMetaObject::connectSlotsByName(ReceiptListWidget);
    } // setupUi

    void retranslateUi(QWidget *ReceiptListWidget)
    {
        ReceiptListWidget->setWindowTitle(QApplication::translate("ReceiptListWidget", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("ReceiptListWidget", "\346\227\245\346\234\237\347\255\233\351\200\211:", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("ReceiptListWidget", "1/1\351\241\265", Q_NULLPTR));
        checkButton->setText(QApplication::translate("ReceiptListWidget", "\346\237\245\347\234\213", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ReceiptListWidget: public Ui_ReceiptListWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_RECEIPTLISTWIDGET_H
