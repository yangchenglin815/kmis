/********************************************************************************
** Form generated from reading UI file 'ReportLossWidget.ui'
**
...
#ifndef UI_REPORTLOSSWIDGET_H
#define UI_REPORTLOSSWIDGET_H
...
public:
    ...
    ReportLossTitleWidget *titleWidget;
    ReportLossListView *listView;
    ...
    void setupUi(QWidget *ReportLossWidget)
    {
        if (ReportLossWidget->objectName().isEmpty())
            ReportLossWidget->setObjectName(QStringLiteral("ReportLossWidget"));
        ReportLossWidget->resize(766, 523);
        ReportLossWidget->setSizeIncrement(QSize(76, 52));
        ReportLossWidget->setBaseSize(QSize(766, 523));
        verticalLayout = new QVBoxLayout(ReportLossWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(ReportLossWidget);
...
"color:#999999;"));
        ...
        mainWidget = new QWidget(ReportLossWidget);
        mainWidget->setObjectName(QStringLiteral("mainWidget"));
        verticalLayout_2 = new QVBoxLayout(mainWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        titleWidget = new ReportLossTitleWidget(mainWidget);
        ...
        listView = new ReportLossListView(mainWidget);
...
"}"));
        ...
        reviewButton = new QPushButton(widget_3);
        reviewButton->setObjectName(QStringLiteral("reviewButton"));
        sizePolicy1.setHeightForWidth(reviewButton->sizePolicy().hasHeightForWidth());
        reviewButton->setSizePolicy(sizePolicy1);
        reviewButton->setStyleSheet(QLatin1String("QPushButton{\n"
"        font-size:16px;\n"
"        color:#ffffff;\n"
"        border-image: url(:/adjustPrice/blueButton.png);\n"
"}\n"
...
"}"));
        ...
        horizontalLayout_6->addWidget(reviewButton);
...
"}"));
        ...
        retranslateUi(ReportLossWidget);

        QMetaObject::connectSlotsByName(ReportLossWidget);
    } // setupUi

    void retranslateUi(QWidget *ReportLossWidget)
    {
        ReportLossWidget->setWindowTitle(QApplication::translate("ReportLossWidget", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("ReportLossWidget", "\346\227\245\346\234\237\347\255\233\351\200\211\357\274\232", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("ReportLossWidget", "1/1\351\241\265", Q_NULLPTR));
        deleteButton->setText(QApplication::translate("ReportLossWidget", "\345\210\240\351\231\244", Q_NULLPTR));
        reviewButton->setText(QApplication::translate("ReportLossWidget", "\345\256\241\346\240\270", Q_NULLPTR));
        printButton->setText(QApplication::translate("ReportLossWidget", "\346\211\223\345\215\260", Q_NULLPTR));
        checkButton->setText(QApplication::translate("ReportLossWidget", "\346\237\245\347\234\213", Q_NULLPTR));
        editButton->setText(QApplication::translate("ReportLossWidget", "\347\274\226\350\276\221", Q_NULLPTR));
        addButton->setText(QApplication::translate("ReportLossWidget", "\346\226\260\345\242\236", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class ReportLossWidget: public Ui_ReportLossWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_REPORTLOSSWIDGET_H
