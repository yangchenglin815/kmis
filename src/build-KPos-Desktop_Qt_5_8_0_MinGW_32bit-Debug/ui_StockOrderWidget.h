/********************************************************************************
** Form generated from reading UI file 'StockOrderWidget.ui'
**
...
#ifndef UI_STOCKORDERWIDGET_H
#define UI_STOCKORDERWIDGET_H
...
public:
    ...
    StockOrderTitleWidget *titleWidget;
    StockOrderListView *listView;
    ...
    void setupUi(QWidget *StockOrderWidget)
    {
        if (StockOrderWidget->objectName().isEmpty())
            StockOrderWidget->setObjectName(QStringLiteral("StockOrderWidget"));
        StockOrderWidget->resize(766, 523);
        verticalLayout = new QVBoxLayout(StockOrderWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(StockOrderWidget);
...
"color:#999999;"));
        ...
        mainWidget = new QWidget(StockOrderWidget);
        mainWidget->setObjectName(QStringLiteral("mainWidget"));
        verticalLayout_2 = new QVBoxLayout(mainWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        titleWidget = new StockOrderTitleWidget(mainWidget);
        ...
        listView = new StockOrderListView(mainWidget);
...
"}"));
        ...
        retranslateUi(StockOrderWidget);

        QMetaObject::connectSlotsByName(StockOrderWidget);
    } // setupUi

    void retranslateUi(QWidget *StockOrderWidget)
    {
        StockOrderWidget->setWindowTitle(QApplication::translate("StockOrderWidget", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("StockOrderWidget", "\346\227\245\346\234\237\347\255\233\351\200\211\357\274\232", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("StockOrderWidget", "1/1\351\241\265", Q_NULLPTR));
        deleteButton->setText(QApplication::translate("StockOrderWidget", "\345\210\240\351\231\244", Q_NULLPTR));
        checkButton->setText(QApplication::translate("StockOrderWidget", "\345\256\241\346\240\270", Q_NULLPTR));
        printButton->setText(QApplication::translate("StockOrderWidget", "\346\211\223\345\215\260", Q_NULLPTR));
        searchButton->setText(QApplication::translate("StockOrderWidget", "\346\237\245\347\234\213", Q_NULLPTR));
        editButton->setText(QApplication::translate("StockOrderWidget", "\347\274\226\350\276\221", Q_NULLPTR));
        addButton->setText(QApplication::translate("StockOrderWidget", "\346\226\260\345\242\236", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class StockOrderWidget: public Ui_StockOrderWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_STOCKORDERWIDGET_H
