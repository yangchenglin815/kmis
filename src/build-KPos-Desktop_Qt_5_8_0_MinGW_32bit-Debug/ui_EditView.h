...
#include "../InStock/GoodsSelectWidget.h"
...
public:
    ...
    void setupUi(QWidget *EditView)
    {
        ...
        EditView->resize(755, 523);
        EditView->setSizeIncrement(QSize(76, 52));
        EditView->setBaseSize(QSize(766, 523));
        horizontalLayout = new QHBoxLayout(EditView);
        horizontalLayout->setSpacing(0);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(0, -1, 0, 0);
        leftWidget = new QWidget(EditView);
...
"}"));
        ...
        goodsSelectWidget = new GoodsSelectWidget(leftWidget);
        ...
        middleWidget = new QWidget(EditView);
        ...
        goodsWidget->setSizeIncrement(QSize(41, 35));
        ...
        operateWidget->setSizeIncrement(QSize(41, 5));
        operateWidget->setBaseSize(QSize(412, 53));
...
"}"));
        ...
        quickAddButton = new QPushButton(operateWidget);
        quickAddButton->setObjectName(QStringLiteral("quickAddButton"));
        sizePolicy.setHeightForWidth(quickAddButton->sizePolicy().hasHeightForWidth());
        quickAddButton->setSizePolicy(sizePolicy);
        quickAddButton->setStyleSheet(QLatin1String("QPushButton{\n"
"        font-size:16px;\n"
"        color:#ffffff;\n"
"        border-image: url(:/adjustPrice/blueButton.png);\n"
"}\n"
...
"}"));
        ...
        horizontalLayout_5->addWidget(quickAddButton);
...
"}"));
        ...
        rightWidget = new QWidget(EditView);
...
"}"));
    ...
    {
        EditView->setWindowTitle(QApplication::translate("EditView", "Form", Q_NULLPTR));
        deleteButton->setText(QApplication::translate("EditView", "\345\210\240\351\231\244", Q_NULLPTR));
        modifyButton->setText(QApplication::translate("EditView", "\344\277\256\346\224\271", Q_NULLPTR));
        quickAddButton->setText(QApplication::translate("EditView", "\345\277\253\351\200\237\345\273\272\346\241\243", Q_NULLPTR));
        printBtn->setText(QApplication::translate("EditView", "\346\211\223\345\215\260", Q_NULLPTR));
        saveButton->setText(QApplication::translate("EditView", "\344\277\235\345\255\230", Q_NULLPTR));
        categoryFrontButton->setText(QString());
        categoryNextButton->setText(QApplication::translate("EditView", "1/12\351\241\265", Q_NULLPTR));
        goodsFrontButton->setText(QString());
        goodsNextButton->setText(QApplication::translate("EditView", "1/12\351\241\265", Q_NULLPTR));
    } // retranslateUi
