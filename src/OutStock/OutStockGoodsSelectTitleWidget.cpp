#include "OutStockGoodsSelectTitleWidget.h"
#include <QPainter>
#include "constData.h"

OutStockGoodsSelectTitleWidget::OutStockGoodsSelectTitleWidget(QWidget *parent)
    : QWidget(parent)
{

}

void OutStockGoodsSelectTitleWidget::paintEvent(QPaintEvent *event)
{
