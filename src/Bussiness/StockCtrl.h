...
class StockCtrl : public QObject
{
    Q_OBJECT
public:
    explicit StockCtrl(QObject *parent = 0);
    ...
    void saveStockOrderRequest(int nOrderId, const QList<StockSelectGoodsInfo>& selectGoodsInfoList);
