...
AdjustPriceGoodsSelectTitleWidget::AdjustPriceGoodsSelectTitleWidget(QWidget *parent) : QWidget(parent)
{

}

void AdjustPriceGoodsSelectTitleWidget::paintEvent(QPaintEvent *event)
{
    ...
    static const int c_nFirstColWidth = 30*g_heightRate;
    static const int c_nSecondColWidth = 64*g_heightRate;
    static const int c_nThirdColWidth = 67*g_heightRate;
    static const int c_nFourthColWidth = 91*g_heightRate;
