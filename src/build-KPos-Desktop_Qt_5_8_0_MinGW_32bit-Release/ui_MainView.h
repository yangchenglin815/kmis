...
#include "../InStock/ListView.h"
#include "../InStock/TitleWidget.h"
...
public:
    ...
    void setupUi(QWidget *MainView)
    {
        ...
        MainView->resize(766, 523);
        MainView->setSizeIncrement(QSize(76, 52));
        MainView->setBaseSize(QSize(766, 523));
        verticalLayout = new QVBoxLayout(MainView);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(MainView);
...
"}"));
    ...
    void retranslateUi(QWidget *MainView)
    {
        ...
        label->setText(QApplication::translate("MainView", "\346\227\245\346\234\237\347\255\233\351\200\211\357\274\232", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("MainView", "1/1\351\241\265", Q_NULLPTR));
        deleteButton->setText(QApplication::translate("MainView", "\345\210\240\351\231\244", Q_NULLPTR));
        checkButton->setText(QApplication::translate("MainView", "\345\256\241\346\240\270", Q_NULLPTR));
        printButton->setText(QApplication::translate("MainView", "\346\211\223\345\215\260", Q_NULLPTR));
        searchButton->setText(QApplication::translate("MainView", "\346\237\245\347\234\213", Q_NULLPTR));
        editButton->setText(QApplication::translate("MainView", "\347\274\226\350\276\221", Q_NULLPTR));
        addButton->setText(QApplication::translate("MainView", "\346\226\260\345\242\236", Q_NULLPTR));
    } // retranslateUi
