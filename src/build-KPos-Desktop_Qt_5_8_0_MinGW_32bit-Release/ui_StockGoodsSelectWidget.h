/********************************************************************************
** Form generated from reading UI file 'StockGoodsSelectWidget.ui'
**
...
#ifndef UI_STOCKGOODSSELECTWIDGET_H
#define UI_STOCKGOODSSELECTWIDGET_H
...
class Ui_StockGoodsSelectWidget
{
public:
    QVBoxLayout *verticalLayout;
    StockGoodsSelectTitleWidget *titleWidget;
    StockGoodsSelectListView *listView;
    QWidget *leftWidget;
    ...
    void setupUi(QWidget *StockGoodsSelectWidget)
    {
        if (StockGoodsSelectWidget->objectName().isEmpty())
            StockGoodsSelectWidget->setObjectName(QStringLiteral("StockGoodsSelectWidget"));
        StockGoodsSelectWidget->resize(288, 470);
        verticalLayout = new QVBoxLayout(StockGoodsSelectWidget);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        titleWidget = new StockGoodsSelectTitleWidget(StockGoodsSelectWidget);
        ...
        listView = new StockGoodsSelectListView(StockGoodsSelectWidget);
...
"background-color: rgb(250, 250, 250);"));
        ...
        leftWidget = new QWidget(StockGoodsSelectWidget);
...
"padding-top:6px;"));
        ...
        retranslateUi(StockGoodsSelectWidget);

        QMetaObject::connectSlotsByName(StockGoodsSelectWidget);
    } // setupUi

    void retranslateUi(QWidget *StockGoodsSelectWidget)
    {
        StockGoodsSelectWidget->setWindowTitle(QApplication::translate("StockGoodsSelectWidget", "Form", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("StockGoodsSelectWidget", "1/1\351\241\265", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class StockGoodsSelectWidget: public Ui_StockGoodsSelectWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_STOCKGOODSSELECTWIDGET_H
