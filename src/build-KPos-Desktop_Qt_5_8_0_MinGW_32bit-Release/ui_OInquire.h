/********************************************************************************
** Form generated from reading UI file 'OInquire.ui'
**
...
#ifndef UI_OINQUIRE_H
#define UI_OINQUIRE_H
...
#include "../OutStock/OInquireListView.h"
#include "../OutStock/OInquireTitleWidget.h"
...
public:
    ...
    OInquireTitleWidget *titleWidget;
    OInquireListView *listView;
    ...
    void setupUi(QWidget *OInquire)
    {
        if (OInquire->objectName().isEmpty())
            OInquire->setObjectName(QStringLiteral("OInquire"));
        OInquire->resize(766, 523);
        verticalLayout = new QVBoxLayout(OInquire);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        topWidget = new QWidget(OInquire);
        ...
        listView = new OInquireListView(mainWidget);
...
""));
        ...
        retranslateUi(OInquire);

        QMetaObject::connectSlotsByName(OInquire);
    } // setupUi

    void retranslateUi(QWidget *OInquire)
    {
        OInquire->setWindowTitle(QApplication::translate("OInquire", "Form", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("OInquire", "1/1\351\241\265", Q_NULLPTR));
        label->setText(QApplication::translate("OInquire", "\346\200\273\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        totalLabel->setText(QApplication::translate("OInquire", "\357\277\24510000.00", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class OInquire: public Ui_OInquire {};
} // namespace Ui
