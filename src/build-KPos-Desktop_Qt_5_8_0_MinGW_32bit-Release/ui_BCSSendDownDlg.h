/********************************************************************************
** Form generated from reading UI file 'BCSSendDownDlg.ui'
**
...
#ifndef UI_BCSSENDDOWNDLG_H
#define UI_BCSSENDDOWNDLG_H
...
public:
    ...
    BCSSendDownTitleWidget *widget_4;
    BCSSendDownListView *listView;
    QWidget *widget;
    ...
    void setupUi(QDialog *BCSSendDownDlg)
    {
        if (BCSSendDownDlg->objectName().isEmpty())
            BCSSendDownDlg->setObjectName(QStringLiteral("BCSSendDownDlg"));
        BCSSendDownDlg->resize(654, 355);
        verticalLayout = new QVBoxLayout(BCSSendDownDlg);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        titleWidget = new TitleBarWidget(BCSSendDownDlg);
        ...
        skinWidget = new QWidget(BCSSendDownDlg);
...
"}"));
        ...
        widget_4 = new BCSSendDownTitleWidget(skinWidget);
        widget_4->setObjectName(QStringLiteral("widget_4"));
        widget_4->setMinimumSize(QSize(0, 36));

        verticalLayout_2->addWidget(widget_4);

        listView = new BCSSendDownListView(skinWidget);
...
"}"));
        ...
        retranslateUi(BCSSendDownDlg);

        QMetaObject::connectSlotsByName(BCSSendDownDlg);
    } // setupUi

    void retranslateUi(QDialog *BCSSendDownDlg)
    {
        BCSSendDownDlg->setWindowTitle(QApplication::translate("BCSSendDownDlg", "Dialog", Q_NULLPTR));
        lastPageButton->setText(QString());
        nextPageButton->setText(QString());
        pageLabel->setText(QApplication::translate("BCSSendDownDlg", "1/2\351\241\265", Q_NULLPTR));
        confirmButton->setText(QApplication::translate("BCSSendDownDlg", "\347\241\256\345\256\232", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class BCSSendDownDlg: public Ui_BCSSendDownDlg {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_BCSSENDDOWNDLG_H
