/********************************************************************************
** Form generated from reading UI file 'RefundPayDlg.ui'
**
...
#ifndef UI_REFUNDPAYDLG_H
#define UI_REFUNDPAYDLG_H
...
public:
    ...
    void setupUi(QDialog *RefundPayDlg)
    {
        if (RefundPayDlg->objectName().isEmpty())
            RefundPayDlg->setObjectName(QStringLiteral("RefundPayDlg"));
        RefundPayDlg->resize(370, 231);
        RefundPayDlg->setMinimumSize(QSize(370, 231));
        titleWnd = new TitleBarWidget(RefundPayDlg);
        titleWnd->setObjectName(QStringLiteral("titleWnd"));
        titleWnd->setGeometry(QRect(0, 0, 370, 40));
        titleWnd->setMinimumSize(QSize(0, 40));
        titleWnd->setMaximumSize(QSize(16777215, 60));
        widget_2 = new QWidget(RefundPayDlg);
        widget_2->setObjectName(QStringLiteral("widget_2"));
        widget_2->setGeometry(QRect(0, 40, 370, 191));
...
"color: rgb(117, 171, 87);"));
        ...
        retranslateUi(RefundPayDlg);

        QMetaObject::connectSlotsByName(RefundPayDlg);
    } // setupUi

    void retranslateUi(QDialog *RefundPayDlg)
    {
        RefundPayDlg->setWindowTitle(QApplication::translate("RefundPayDlg", "RefundPayDlg", Q_NULLPTR));
        refreshButton->setText(QApplication::translate("RefundPayDlg", "\345\210\267\346\226\260", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("RefundPayDlg", "\345\217\226\346\266\210", Q_NULLPTR));
        rechargeLabel->setText(QApplication::translate("RefundPayDlg", "\345\205\205\345\200\274\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        statusLabel->setText(QApplication::translate("RefundPayDlg", "\346\224\257\344\273\230\347\212\266\346\200\201\357\274\232", Q_NULLPTR));
        rechargeAmtLabel->setText(QApplication::translate("RefundPayDlg", "\357\277\24537.02", Q_NULLPTR));
        statusValueLabel->setText(QApplication::translate("RefundPayDlg", "\346\210\220\345\212\237", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class RefundPayDlg: public Ui_RefundPayDlg {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_REFUNDPAYDLG_H
