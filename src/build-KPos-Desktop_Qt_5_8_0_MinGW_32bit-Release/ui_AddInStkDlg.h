/********************************************************************************
** Form generated from reading UI file 'AddInStkDlg.ui'
**
...
#ifndef UI_ADDINSTKDLG_H
#define UI_ADDINSTKDLG_H
...
public:
    ...
    void setupUi(QDialog *AddInStkDlg)
    {
        if (AddInStkDlg->objectName().isEmpty())
            AddInStkDlg->setObjectName(QStringLiteral("AddInStkDlg"));
        AddInStkDlg->resize(660, 406);
        AddInStkDlg->setSizeIncrement(QSize(66, 40));
        AddInStkDlg->setBaseSize(QSize(660, 406));
        verticalLayout = new QVBoxLayout(AddInStkDlg);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        titleWidget = new TitleBarWidget(AddInStkDlg);
        ...
        mainWidget = new QWidget(AddInStkDlg);
...
"}"));
        ...
        widget_2->setSizeIncrement(QSize(28, 36));
        widget_2->setBaseSize(QSize(284, 362));
...
"}"));
        ...
        label_2->setGeometry(QRect(20, 15, 61, 20));
        QFont font1;
...
"padding-left:10px;"));
        ...
        countLedit->setGeometry(QRect(90, 50, 170, 31));
...
"padding-left:10px;"));
        ...
        boxNumLedit->setGeometry(QRect(90, 90, 170, 31));
...
"padding-left:10px;"));
        ...
        subTotalLb->setGeometry(QRect(90, 130, 170, 31));
        QPalette palette;
...
"}"));
        ...
        keyboardWidget->setSizeIncrement(QSize(29, 29));
        keyboardWidget->setBaseSize(QSize(294, 294));
        ...
        retranslateUi(AddInStkDlg);

        QMetaObject::connectSlotsByName(AddInStkDlg);
    } // setupUi

    void retranslateUi(QDialog *AddInStkDlg)
    {
        AddInStkDlg->setWindowTitle(QApplication::translate("AddInStkDlg", "Dialog", Q_NULLPTR));
        goodsNameLabel->setText(QApplication::translate("AddInStkDlg", "\345\225\206\345\223\201\345\220\215\347\247\260\357\274\232", Q_NULLPTR));
        goodsCodeLabel->setText(QApplication::translate("AddInStkDlg", "\345\225\206\345\223\201\347\274\226\345\217\267\357\274\232", Q_NULLPTR));
        goodsKindLabel->setText(QApplication::translate("AddInStkDlg", "      \345\244\247\347\261\273\357\274\232", Q_NULLPTR));
        goodsUnitLabel->setText(QApplication::translate("AddInStkDlg", "\350\247\204\346\240\274\345\215\225\344\275\215\357\274\232", Q_NULLPTR));
        label_2->setText(QApplication::translate("AddInStkDlg", "\345\215\225\344\273\267\357\274\232", Q_NULLPTR));
        label->setText(QApplication::translate("AddInStkDlg", "\346\225\260\351\207\217\357\274\232", Q_NULLPTR));
        label_5->setText(QApplication::translate("AddInStkDlg", "\344\273\266\346\225\260\357\274\232", Q_NULLPTR));
        label_6->setText(QApplication::translate("AddInStkDlg", "\345\260\217\350\256\241\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        priceLedit->setText(QApplication::translate("AddInStkDlg", "0.00", Q_NULLPTR));
        countLedit->setText(QApplication::translate("AddInStkDlg", "0.00", Q_NULLPTR));
        boxNumLedit->setText(QApplication::translate("AddInStkDlg", "0.00", Q_NULLPTR));
        subTotalLb->setText(QString());
        saveButton->setText(QApplication::translate("AddInStkDlg", "\344\277\235\345\255\230", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class AddInStkDlg: public Ui_AddInStkDlg {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDINSTKDLG_H
