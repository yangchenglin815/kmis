/********************************************************************************
** Form generated from reading UI file 'MemChargeDialog.ui'
**
...
#ifndef UI_MEMCHARGEDIALOG_H
#define UI_MEMCHARGEDIALOG_H
...
public:
    ...
    void setupUi(QDialog *MemChargeDialog)
    {
        if (MemChargeDialog->objectName().isEmpty())
            MemChargeDialog->setObjectName(QStringLiteral("MemChargeDialog"));
        MemChargeDialog->resize(370, 231);
        MemChargeDialog->setMinimumSize(QSize(370, 231));
        gridLayout_2 = new QGridLayout(MemChargeDialog);
        gridLayout_2->setSpacing(0);
        gridLayout_2->setContentsMargins(11, 11, 11, 11);
        gridLayout_2->setObjectName(QStringLiteral("gridLayout_2"));
        gridLayout_2->setContentsMargins(0, 0, 0, 0);
        titleWnd = new TitleBarWidget(MemChargeDialog);
        ...
        widget_2 = new QWidget(MemChargeDialog);
...
"color: rgb(117, 171, 87);"));
        ...
        retranslateUi(MemChargeDialog);

        QMetaObject::connectSlotsByName(MemChargeDialog);
    } // setupUi

    void retranslateUi(QDialog *MemChargeDialog)
    {
        MemChargeDialog->setWindowTitle(QApplication::translate("MemChargeDialog", "MemChargeDialog", Q_NULLPTR));
        refreshButton->setText(QApplication::translate("MemChargeDialog", "\345\210\267\346\226\260", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("MemChargeDialog", "\345\217\226\346\266\210", Q_NULLPTR));
        rechargeLabel->setText(QApplication::translate("MemChargeDialog", "\345\205\205\345\200\274\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        statusLabel->setText(QApplication::translate("MemChargeDialog", "\346\224\257\344\273\230\347\212\266\346\200\201\357\274\232", Q_NULLPTR));
        rechargeAmtLabel->setText(QApplication::translate("MemChargeDialog", "\357\277\24537.02", Q_NULLPTR));
        statusValueLabel->setText(QApplication::translate("MemChargeDialog", "\346\210\220\345\212\237", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class MemChargeDialog: public Ui_MemChargeDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MEMCHARGEDIALOG_H
