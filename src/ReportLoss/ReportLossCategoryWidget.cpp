...
#include "ui_ReportLossCategoryWidget.h"
#include "../data/constData.h"

ReportLossCategoryWidget::ReportLossCategoryWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ReportLossCategoryWidget)
  , m_nCurPage(1)
  , m_nTotalPage(1)
  , m_nOnePageCount(10)
...
ReportLossCategoryWidget::~ReportLossCategoryWidget()
{
    delete ui;
}

void ReportLossCategoryWidget::setUpDownPageButton(QPushButton *pUpPageButton, QPushButton *pDownPageButton)
{
...
void ReportLossCategoryWidget::initData(QList<CategoryInfo *> categoryInfoList)
{
...
void ReportLossCategoryWidget::searchGoods(QList<GoodsInfo> &goodsInfoList, QString searchText)
{
...
void ReportLossCategoryWidget::searchGood(GoodsInfo &info, int goodsId)
{
    //获取商品信息
        int nLen = m_categoryInfoList.length();
        int nLen2 = 0;
...
void ReportLossCategoryWidget::slot_upPage()
{
    m_nCurPage--;
    checkCurPageButtonState();
    generateUI();
...
void ReportLossCategoryWidget::slot_downPage()
{
    m_nCurPage++;
    checkCurPageButtonState();
    generateUI();
...
void ReportLossCategoryWidget::resizeEvent(QResizeEvent *)
{
...
void ReportLossCategoryWidget::generateUI()
{
...
void ReportLossCategoryWidget::checkCurPageButtonState()
{
...
void ReportLossCategoryWidget::initConnect()
{
